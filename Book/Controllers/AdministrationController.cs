...
namespace Book.Controllers
{
    ...
    {
        public readonly RoleManager<AppRole> roleManager;
        ...
        public async Task<IActionResult> EditRole(string id)
        {
            ...
            if (role == null)
            {
                ViewBag.ErrorMessage = $"Role by Id:{id}Cannot find";
        ...
        public async Task<IActionResult> EditRole(EditRoleViewModel model)
        {
            ...
            if (role == null)
            {
                ViewBag.ErrorMessage = $"Role by Id:{model.Id}Cannot find";
                return View("NotFound");
            }
            else
            {
        ...
        public async Task<IActionResult> EditUserInRole(string roleId)
        {
            ...
            if (role == null)
            {
                ViewBag.ErrorMessage = $"Role By Id {roleId} Cannot be Found";
                return View("NotFound");
            }
